...
function formatCurrencyToTable(value) {
  return value.toLocaleString("pt-BR", { style: "currency", currency: "BRL" }); //especifica a quantidade de casas decimais.
}
...
nextButton.addEventListener("click", () => {
  // Puxa a tela para a esquerda, a fim de deslisar para a direita (imagine a tela de um celular).
  carouselEl.scrollLeft += mainEl.clientWidth;
});

previousButton.addEventListener("click", () => {
  // Puxa a tela para a direita, a fim de deslisar para a esquerda (imagine a tela de um celular).
  carouselEl.scrollLeft -= mainEl.clientWidth;
});
